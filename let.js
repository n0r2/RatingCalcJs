...
const MUSIC = { //12+以上定数確定
  ...
  "442": ["Glorious Crown (tpz over-Over-OVERCUTE REMIX)", 13.9],
  "445": ["Palette", 12.1],
  "447": ["パーフェクト生命", 12.7],
  ...
  "466": ["Iudicium", 13.7],
  "467": ["Twice up Scenery", 13.0],
  "468": ["奏者はただ背中と提琴で語るのみ", 12.9],
  "469": ["Xevel", 13.9],
  "470": ["セイクリッド　ルイン", 13.5],
  "471": ["極圏", 13.6],
  "472": ["Scarlet Lance", 13.6],
  "478": ["Fire◎Flower", 12.4],
  "479": ["卑怯戦隊うろたんだー", 12.3],
